...
<!-- Copy this file to task_list.md and fill in each numbered task for your project.

Numbered tasks are attempted sequentially, in the order defined here. The agent
works through them one at a time: the tip of a successful task becomes the base
for the next task; a failed task is committed then reverted, leaving the tip
unchanged.
...
<!-- What the agent should do. Be specific about files, behaviors, and intent. -->

### Pass Criteria

<!-- How success is verified. Prefer concrete, runnable checks — e.g., exact
test commands, expected outputs, files that must exist. Vague criteria cause
vague outcomes. -->
